...
pca_rotation_df <- data.frame(Variable = rownames(pca_rotation), PC1 = pca_rotation[, 1], PC2 = pca_rotation[, 2])

pca_rotation_longs <- tidyr::pivot_longer(pca_rotation_df, cols = -Variable, names_to = "PCA", values_to = "Rotation")
