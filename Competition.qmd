...
#重新調整欄位index
#colnames(DB.csv)
DB.csv <- DB.csv[,c('q1','q2_rr','q4','q5_1','q6','q7','q10','q11','q17_01','q17_02','q19_01','q19_02','q1719','q20','q22','q23','q24','q25','q26','q27_1','q28_YN','q28_1','q28_2','q28_3','q29_1','q29_2','q29_3','q30_1','q31_1','q32_1','q33_1','q34_1','q35_1','q36_1','q38','q39_1','q40','q41','q42_1','weight')]

for(i in c(1:3,5:39)){
  DB.csv[,i] <- as.integer(DB.csv[,i])
}

colnames(DB.csv) <- c('q1','q2_rr','q4','q5','q6','q7','q10','q11','q17_1','q17_2','q19_1','q19_2','q1719','q20','q22','q23','q24','q25','q26','q27','q28_YN','q28_1','q28_2','q28_3','q29_1','q29_2','q29_3','q30','q31','q32','q33','q34','q35','q36','q38','q39','q40','q41','q42','weight')
```
...
glm_log <- glm(
  factor(q28_YN)~
    factor(q1)+ q2_rr+ q4+ q5+ q6+ q7+ q10+ q11+
...
```{r, fig.align='center', fig.width=8, fig.height=3, out.width="100%"}
library(rpart)
library(rpart.plot)
tree_model <- rpart(
  factor(q28_YN)~
...
allx <-boycott[,c("q2_rr","q4","q5","q6","q7","q10","q11","q1719","q20","q22","q23","q24","q25","q26","q27","q28_1_2","q28_3","q29_1","q29_2","q29_3","q31",'q33',"q34",'q36',"q29_1_2","q29_1_3","q38","q39","q40","q41","q42")]
...
y <-boycott[,c('q30','q32','q35')]
x <-boycott[,c("q2_rr","q4","q6","q7","q10","q11","q1719","q22","q23","q24","q26","q27","q29_1","q29_2","q29_3","q31",'q33','q36',"q29_1_2","q29_1_3","q40","q42")]
