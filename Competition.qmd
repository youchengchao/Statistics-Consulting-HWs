...
# V <- c("q1","q2_rr","q4",'q17_01','q17_02','q19_01','q19_02','q1719_label',
#        "q28_YN",'q28_1','q28_2','q28_3','q29_1','q29_2','q29_3')
# for(name in V) DB.csv[,name] <- as.factor(DB.csv[,name])
# str(DB.csv)
```
...
```{r, fig.align='center', fig.width=10, fig.height=6, out.width='100%'}
...
xgb.plot.tree(model = xgb_model,trees = 1:5,show_node_id = T)
...
```{r}
library(caTools)
selected <- caTools::sample.split(DB.csv$q28_YN, SplitRatio = 0.7)
trainDB <- DB.csv[selected,]
testDB <- DB.csv[!selected,]
