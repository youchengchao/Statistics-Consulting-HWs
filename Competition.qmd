...
allx_lodings[,c(1,2)]
ally_lodings[,c(1,2)]
#第一典型變數與q22,q33_1高度相關,q2(負),q4,q10,q23,q24,q26,q29_1,q29_3,q31_1,q36_1,q29_1_3中度相關
...
```{r, fig.align='center', fig.width=6, fig.height=2, out.width="100%"}
y <-boycott[,c('q30','q32','q35')]
...
```{r, fig.align='center', fig.width=4, fig.height=8,out.width="100%"}
library(xgboost)
library(DiagrammeR)
set.seed(2012)
...
shap.plot.summary(shap_long,
  ...
  labs(color = "Shap值", y = "Shap值", x = "變數名稱")
```
