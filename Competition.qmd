...
Barplot.p <- function(din){
  ...
  ggplot(temp, aes(x = factor(!!sym(split_label)), y = proportion, fill = factor(!!sym(cat_label)))) +
    ...
    labs(x = "Proportion", y = "Percentage", fill = "A") +
...
```{r}
Barplot.p(din=counts_16_18)
Barplot.p(din=counts_20_01)
Barplot.p(din=counts_20_02)
Barplot.p(din=counts_22)
Barplot.p(din=counts_23)
Barplot.p(din=counts_24)
Barplot.p(din=counts_25)
Barplot.p(din=counts_26)
Barplot.p(din=counts_27)
Barplot.p(din=counts_38)
Barplot.p(din=counts_39)
Barplot.p(din=counts_40)
Barplot.p(din=counts_41)
...
```{r}
fit.logistic <- glm(
  factor(q28_5)~q24_01_1+q24_02_1+q24_03_1+q24_04_1+q24_05_1 ,
  data = DB.csv,
  family = binomial
)
