...
DB.csv <- DB.csv[,c('q1','q2','q2_rr','q4','q5_1','q6','q7','q10','q11','q17_01','q17_02','q19_01','q19_02','q1719_label','q20','q22','q23','q24','q25','q26','q27_1','q28_YN','q28_1','q28_2','q28_3','q29_1','q29_2','q29_3','q30_1','q31_1','q32_1','q33_1','q34_1','q35_1','q36_1','q38','q39_1','q40','q41','q42_1','weight')]
for(i in c(1:4,6:41)){
...
+-------------+--------------+---------------------------------------+
| V aria bles | Explanation  | Manipulation                          |
+=============+==============+=======================================+
| q1          | 性別         |                                       |
+-------------+--------------+---------------------------------------+
| q2          | 年齡         | 出生年改成年齡                        |
+-------------+--------------+---------------------------------------+
| q 2_rr      | 年齡分層     | 將 rrq2 的年齡分層變數重新命名"q2_rr" |
+-------------+--------------+---------------------------------------+
| q3          | 地區         | 因為關心網路的活動，認為地區不會影響  |
+-------------+--------------+---------------------------------------+
| q4          | 教育程度     | 教育程度: 重新劃分為四個等級 (1:      |
|             |              | 高中及以下, 2: 專科, 3: 大學, 4:      |
|             |              | 研                                    |
|             |              | 究所)，劃分參考人口結構表格的分類方式 |
+-------------+--------------+---------------------------------------+
...
|             | 幾個與名人討 | 名人討論相關的社群媒體"，             |
|             | 論相         | 因為                                  |
|             | 關的社群媒體 | 有些社群媒體不會造成抵制名人行為，例  |
|             |              | 如:Pinterest,Linkedin,+ 其他類        |
|             |              | Pixiv,Mobile01,Komica,MeWe            |
|             |              | 跟名                                  |
|             |              | 人相關的討論比較少，所以決定簡化選項, |
|             |              | 巴 哈姆特,                            |
|             |              | 巴哈姆特場外休憩區兩個則要計算        |
+-------------+--------------+---------------------------------------+
| q11         | 是否使用YT,  | 改成" 有無使用 YT, Twitch, 或         |
|             | Twit         | bilibili"(1: 有使用,0:                |
|             | ch或bilibili | 沒有使用)，原因與第十題類似。         |
+-------------+--------------+---------------------------------------+
| q12\        |              | 疫情相關題目 ): 關心的題目 (28,29)    |
| \~q15       |              | 時間範圍較                            |
|             |              | 廣，                                  |
|             |              | 並不只局限於疫情期間，所以決定移除。  |
+-------------+--------------+---------------------------------------+
| q16\        | 網路惡搞行為 | 將每個類別補 0(變成                   |
| \~q19       |              | 1,0)，再創建一個標籤變數              |
|             |              | 1719_label(1: 至少有一個惡搞行為,0:   |
|             |              | 都沒有)。                             |
+-------------+--------------+---------------------------------------+
| q20         | 主動激化傾向 | 參考碩士論文:                         |
|             |              | 台灣消費者抵制行為之研究              |
|             |              | ---以台商親中言論衍生之抵制為例       |
|             |              | (https://www.airitilibr               |
|             |              | ary.                                  |
|             |              | com/Article/Detail/U0004-G0107932056) |
|             |              | 之做法，將相同大主題的 ordinal        |
|             |              | 主觀評分加總 作為該主題程度的分數。   |
+-------------+--------------+---------------------------------------+
| q22         | 他人攻擊傾向 |                                       |
...
```{r, fig.align='center', fig.width=8, fig.height=6, out.width='100%'}
var.label <- c("q1","q2_rr","q4","q11",
               "q17_01","q17_02","q19_01","q19_02","q1719_label",
               "q29_1","q29_2","q29_3")
showtext_auto()
...
allx <-boycott[,c("q2_rr","q4","q5_1","q6","q7","q10","q11","q1719_label","q20","q22","q23","q24","q25","q26","q27_1","q28_1_2","q28_3","q29_1","q29_2","q29_3","q31_1",'q33_1','q34_1','q36_1',"q29_1_2_inter","q29_1_3_inter","q38","q39_1","q40","q41","q42_1")]
...
x <-boycott[,c("q2","q4","q6","q7","q10","q11","q1719_label","q22","q23","q24","q26","q27_1","q29_1","q29_2","q29_3","q31_1",'q33_1','q36_1',"q29_1_2_inter","q29_1_3_inter","q40","q42_1")]
...
glm_log <- glm(
  factor(q28_YN)~
    ...
    q1719_label+
    q20+
    q22+ q23+ q24+ q25+ q26+ q27_1, family = binomial, data = DB.csv, weights = weight)
...
x <- model.matrix(factor(q28_YN)~
    ...
    q1719_label+
    q20+
    q22+ q23+ q24+ q25+ q26+ q27_1, data = DB.csv)[, -1]
y <- DB.csv$q28_YN
...
xgb_model <- xgboost(data = xgb_data, objective = "binary:logistic", nrounds = 100,verbose = 0)
...
台灣消費者抵制行為之研究 —以台商親中言論衍生之抵制為例(https://www.airitilibrary.com/Article/Detail/U0004-G0107932056)
