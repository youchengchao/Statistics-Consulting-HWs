...
| q1        |                                                                                                                                                                                                                            |
| q2        | 出生年改成年齡                                                                                                                                                                                                             |
| q 2_rr    | 將 rrq2 的年齡分層變數重新命名"q2_rr"                                                                                                                                                                                      |
| q3        | 因為關心網路的活動，認為地區不會影響                                                                                                                                                                                       |
| q4        | 重新劃分為四個等級，劃分參考人口結構表格的分類方式                                                                                                                                                                         |
| q5_1      |                                                                                                                                                                                                                            |
| q6,q7     | 時間統一單位 (分)                                                                                                                                                                                                          |
| q8        | 大部分的人都有透過網路接觸名人的資訊或討論 (只有四個人沒有)，所以決定移除。                                                                                                                                                |
| q9        | 即時通訊軟體多為聯繫熟人或工作上使用，較難顯現是否有突破同溫層的現象，所以決定移除                                                                                                                                         |
| q10       | 改成"使用幾個與 yt名人討論相關的社群媒體"，因為有些社群媒體不會造成抵制名人行為，例如:Pinterest,Linkedin,+ 其他類Pixiv,Mobile01,Komica,MeWe跟名人相關的討論比較少，所以決定簡化選項,巴哈姆特巴哈姆特場外休憩區兩個則要計算 |
| q11       | 改成" 有無使用 YT, Twitch,或bilibili"(1: 有使用,0:沒有使用)，原因與第十題類似。                                                                                                                                            |
| q12\~q15  | q28,q29關心的時間範圍較廣並不只局限於疫情期間，所以決定移除。                                                                                                                                                              |
...
把相關性\<0.2的刪除 \## Canonical analysis and PCA-對部分變數做
