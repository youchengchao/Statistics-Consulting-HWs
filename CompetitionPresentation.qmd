...
## {background-image=background.jpeg}
### 目的與動機
::: {style="position: absolute; top: 40%; left: 60%;width :100%; transform: translate(-50%, -50%);text-align: left; font-size: 23px; line-height:2;"}
抵制行為已成為民眾表達不滿的重要手段。<br>\
以2023年劉芒事件為例，因工作態度爭議引發訂閱人數下降11%、影片倒讚率高達90%。<br>\
為協助名人理解抵制背後原因並有效應對，本研究建構抵制行為指標，<br>\
描繪抵制者輪廓，並分析其影響。
:::
