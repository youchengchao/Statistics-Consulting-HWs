...
-   H2：針對有做出抵制行為的人，網路使用行為、回聲室效應、網路貶抑發言、政治立場與生活感受和抵制相關調查都會影響抵制程度高低。
...
| q16\~q19 | 將四個網路惡搞行為有無的1,0變數整合成至少有一項網路惡搞行為的1,0變數1719         |
| q20\~q26 | 參考ref\[1\]之做法，將相同主題的ordinal主觀評分加總作為該主題程度的分數。        |
...
| q1       | 性別                             | 1:男性, 2:女性                                                  |
| q2       | 年齡                             | 連續型數值變數                                                  |
| q2rr     | 年齡分層                         | 1:18\~29, 2:30\~39, 3:40\~49,\newline 4:50\~59, 5:60\~69, 6:70+ |
...
# H1之資料分析 - weighted Logistic regression model
